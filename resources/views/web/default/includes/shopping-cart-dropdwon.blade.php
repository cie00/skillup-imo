...
<div class="dropdown">
    <button type="button" {{ (empty($userCarts) or count($userCarts) < 1) ? 'disabled' : '' }} class="btn cus btn-transparent dropdown-toggle" id="navbarShopingCart" data-toggle="dropdown"
