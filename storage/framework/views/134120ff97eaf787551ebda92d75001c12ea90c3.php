                    ...
                    <?php if(!empty($navbarPages) and count($navbarPages)): ?>
                        ...
                        <?php $__currentLoopData = $navbarPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navbarPage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <li class="nav-item">
                                <a 
                                    class="nav-link" 
                                    href="<?php echo e($navbarPage['link']); ?>"
                                    style="<?php echo e($navbarPage['title'] == "Store" ? 'display:none' : ''); ?>"
                                    ><?php echo e($navbarPage['title']); ?></a>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                </ul>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/nani/Desktop/workspace/skillup-imo/resources/views/web/default/includes/navbar.blade.php ENDPATH**/ ?>