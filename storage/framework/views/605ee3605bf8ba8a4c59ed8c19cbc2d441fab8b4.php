                    ...
                    <form method="post" action="/register" class="mt-35">
                        ...
                        <?php if($registerMethod == 'mobile'): ?>
                            ...
                            <?php if($showOtherRegisterMethod): ?>
                                <?php echo $__env->make('web.default.auth.register_includes.email_field',['optional' => false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php endif; ?>
                        <?php else: ?>
                            ...
                            <?php if($showOtherRegisterMethod): ?>
                                <?php echo $__env->make('web.default.auth.register_includes.mobile_field',['optional' => false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php endif; ?>
                        <?php endif; ?>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nani/Desktop/workspace/skillup-imo/resources/views/web/default/auth/register.blade.php ENDPATH**/ ?>