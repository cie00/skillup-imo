        ...
        <div class="top-contact-box border-bottom d-flex flex-column flex-md-row align-items-center justify-content-center">
            ...
            <div class="d-flex align-items-center justify-content-between justify-content-md-center">
                <form action="/search" method="get" class="form-inline my-2 my-lg-0 navbar-search position-relative w-100">
                    <input class="form-control mr-5 rounded w-120" type="text" name="search" placeholder="<?php echo e(trans('navbar.search_anything')); ?>" aria-label="Search">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/nani/Desktop/workspace/skillup-imo/resources/views/web/default/includes/top_nav.blade.php ENDPATH**/ ?>