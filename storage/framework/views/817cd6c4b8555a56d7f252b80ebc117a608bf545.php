            ...
            <div class="form-group">
                ...
                <select name="locale" class="custom-select <?php echo e(!empty($webinar) ? 'js-edit-content-locale' : ''); ?>">
                    <?php $__currentLoopData = $userLanguages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($lang); ?>" <?php if(request()->get('locale', app()->getLocale()) == $lang): ?> selected <?php endif; ?>><?php echo e($language); ?> <?php echo e((!empty($definedLanguage) and is_array($definedLanguage) and in_array(mb_strtolower($lang), $definedLanguage)) ? '('. trans('public.content_defined') .')' : ''); ?></option>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/skillupimoorg/public_html/resources/views/web/default/panel/webinar/create_includes/step_1.blade.php ENDPATH**/ ?>