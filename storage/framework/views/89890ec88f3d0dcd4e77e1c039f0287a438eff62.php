...
<div class="dropdown">
    <button type="button" class="btn cus btn-transparent dropdown-toggle" <?php echo e((empty($unReadNotifications) or count($unReadNotifications) < 1) ? 'disabled' : ''); ?> id="navbarNotification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<?php /**PATH /Users/nani/Desktop/workspace/skillup-imo/resources/views/web/default/includes/notification-dropdown.blade.php ENDPATH**/ ?>