                                        ...
                                        <tr>
                                            ...
                                            <td width="150">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_featured_topics_edit')): ?>
                                                    <a href="/admin/featured-topics/<?php echo e($feature->id); ?>/edit" class="btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.edit')); ?>">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                <?php endif; ?>

                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_featured_topics_delete')): ?>
                                                    <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/featured-topics/'. $feature->id .'/delete','btnClass' => 'btn-sm','icon' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/skillupimoorg/public_html/resources/views/admin/forums/featured_topics/lists.blade.php ENDPATH**/ ?>